<div id="characterComponents" class="hide">
    ...
    <table>
        <tr class="character-reward-row">
            ...
            @if($expanded_rewards)
                <td>
                    {!! Form::select('character_rewardable_type[]', ['Item' => 'Item', 'Currency' => 'Currency','Feature' => 'Trait'] + (isset($showLootTables) && $showLootTables ? ['LootTable' => 'Loot Table'] : []), null, ['class' => 'form-control character-rewardable-type', 'placeholder' => 'Select Reward Type']) !!}
                </td>
                <td class="lootDivs">
                    ...
                    <div class="character-features hide">{!! Form::select('character_feature_id[]', $features, 0, ['class' => 'form-control character-feature-id', 'placeholder' => 'Select Trait']) !!}</div>
