<ul>
    ...
    <li class="sidebar-section">
        ...
        <div class="sidebar-item"><a href="{{ $character->url . '/features' }}" class="{{ set_active('character/'.$character->slug.'/features') }}">Unlocked Traits</a></div>
    </li>
    <li class="sidebar-section">
        ...
        <div class="sidebar-item"><a href="{{ $character->url . '/feature-logs' }}" class="{{ set_active('character/'.$character->slug.'/feature-logs') }}">Trait Logs</a></div>
    </li>
