<style>
    ...
    @for ($t = 1; $t < 10; $t++)
        ...
        @if ($arcade->customImageExists($key))
            .number-panel-{{ $t }} {
                background-image: url("{{ $arcade->customImageUrl($key) }}") !important;
                background-size: cover !important;
                color: transparent !important;
                display: block;
            }

            .number-panel-{{ $t }} .text-danger {
                color: transparent !important;
                background: red;
                background-image: url("{{ $arcade->customImageUrl($key) }}");
                background-size: cover !important;
                display: block;
            }

            .sudoku_board .cell .note-{{ $t }} {
                background-image: url("{{ $arcade->customImageUrl($key) }}");
                background-size: cover !important;
                color: transparent !important;
                width: 30% !important;
        ...
        @else
            ...
            .sudoku_board .number-panel-{{ $t }} .cell.selected.current span {
                color: white;
            }

            .sudoku_board .number-panel-{{ $t }} .cell.fix span {
                color: #7f8c8d;
            }

            .sudoku_board .number-panel-{{ $t }} .cell .solution {
                color: #d35400;
            }

            .sudoku_board .number-panel-{{ $t }} .cell span {
                color: #2c3e50;
                text-align: middle;
            }
