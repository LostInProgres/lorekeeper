...
@section('admin-content')
    ...
    @if ($submission->status == 'Pending')
        ...
        <div class="mb-1">
            ...
            @if ($submission->prompt_id)
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 col-8">{{ $count['all'] }} {!! add_help('This is the number of times the user has submitted this prompt before and had their submission approved.') !!}</div>
                </div>
            @endif
            <div class="row">
                <div class="col-md-2 col-4">
        ...
        @include('home._prompt_limits', ['count' => $count, 'staffView' => True])
