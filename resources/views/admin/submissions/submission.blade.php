    ...
    {!! Form::open(['url' => url()->current(), 'id' => 'submissionForm']) !!}
        ...
        <div id="characters" class="mb-3">
            @foreach($submission->characters as $character)
                @include('widgets._character_select_entry', ['characterCurrencies' => $characterCurrencies, 'items' => $items, 'tables' => $tables, 'character' => $character, 'expanded_rewards' => $expanded_rewards, 'features' => $features])
            @endforeach
        </div>
    ...
    <div id="characterComponents" class="hide">
        ...
        <table>
            <tr class="character-reward-row">
                    ...
                    @if($expanded_rewards)
                    <td>
                        {!! Form::select('character_rewardable_type[]', ['Item' => 'Item', 'Currency' => 'Currency', 'LootTable' => 'Loot Table','Feature' => 'Trait'], null, ['class' => 'form-control character-rewardable-type', 'placeholder' => 'Select Reward Type']) !!}
                    </td>
                    <td class="lootDivs">
                        ...
                        <div class="character-features hide">{!! Form::select('character_rewardable_id[]', $features, 0, ['class' => 'form-control character-feature-id', 'placeholder' => 'Select Trait']) !!}</div>
                    </td>
                    @else
                        <td class="lootDivs">
