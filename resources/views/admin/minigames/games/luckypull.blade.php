    ...
    <div class="col form-group text-center">
        <div class="row">
            <div class="col">
                ...
                <p>The user's fee will be added to the total reward pool every time a user loses, with the first winning user earning the entire pool, then the total pool resets. The minigame must have a fee to use this.</p>
            </div>
            <div class="col">
