...
class AddMinigames extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('minigame_log', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->increments('id');
            $table->integer('minigame_id')->unsigned()->index();
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('minigame_log');
    }
}
